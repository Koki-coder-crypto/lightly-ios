...
final class PurchaseManager: ObservableObject {
    ...
    func refresh() async {
        do {
            ...
            // A new App Store product is unavailable until it is configured in App Store Connect.
            products = []
        }
    ...
    func purchase(_ product: Product) async {
        ...
        do {
            ...
            case .success(let verification):
                let transaction = try checkedTransaction(verification)
