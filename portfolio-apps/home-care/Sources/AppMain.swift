...
private enum AppSpec {
    static let name = "Home Care"
    static let icon = "house.and.flag.fill"
    static let job = "Remember maintenance for filters, appliances, and repairs."
    static let free = "Save up to 10 maintenance records."
    static let pro = "Unlimited maintenance records"
    static let action = "Add maintenance"
    static let freeLimit = 10
    static let monthlyID = "jp.egawa.homecare.pro.monthly"
    static let yearlyID = "jp.egawa.homecare.pro.yearly"
}
...
final class UtilityStore: ObservableObject {
    ...
    private let key = "jp.egawa.homecare.entries"
    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                Section("New maintenance") {
                    TextField("Task", text: $store.title)
                    TextField("Date or note (optional)", text: $store.detail)
                ...
                Section("Saved maintenance") {
                    if store.entries.isEmpty { Text("No maintenance records yet").foregroundStyle(.secondary) }
